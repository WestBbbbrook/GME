...
int main(){
	Mat oriFrame1 = imread("E:\\1.jpg");
	Mat oriFrame2 = imread("E:\\2.jpg");
	Mat oriFrame3 = imread("E:\\3.jpg");
	Mat oriFrame4 = imread("E:\\4.jpg");

	double gme1 = count_GM(oriFrame1);
	double gme2 = count_GM(oriFrame2);
	double gme3 = count_GM(oriFrame3);
	double gme4 = count_GM(oriFrame4);
